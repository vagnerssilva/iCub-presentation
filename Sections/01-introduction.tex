...
\begin{frame}[c]{Uma plataforma open-system}
    \begin{figure}
        \includegraphics[width=0.32\textwidth]{cmap.png}
    \end{figure}
%*----------- notes
    \note[item]{Notes can help you to remember important information. Turn on the notes option.}
\end{frame}
...
\begin{frame}[t]{Objetivo} 
    \centering
    \includegraphics[width=.50\textwidth]{cmap1.png}
...
\begin{frame}[c]{Objetivo} 
    ...
    \begin{center}
        ...
        \begin{center}
            \vspace*{0.5cm}
            \resizebox{!}{0.7cm}{%
                \color{bg} Apoiar a pesquisa colaborativa no 
                desenvolvimento cognitivo por meio da interação
                 autônoma e interação social
            }%
        \end{center}
        \end{shaded}
        }%
...
\begin{frame}[t]{Conclusão}
    \begin{itemize}
        ...
        \item Apoiou pesquisas no desenvolvimento cognitivo %por meio da exploração autônoma e interação social 
...
\begin{frame}[c]{Objetivo} 
    ...
    \begin{center}
        ...
        \begin{center}
            \vspace*{0.5cm}
            \resizebox{!}{0.7cm}{%
                \color{bg} Apoiar a pesquisa colaborativa no desenvolvimento cognitivo por meio da interação autônoma e interação social
            }%
        \end{center}
        \end{shaded}
        }%
